...
abstract class ModuleFactory {
	...
	/**
	 * Método responsável por obter um DataProvider específico a partir seu alias idModule/idDataSource
	 *
	 * @param string $idDataProvider idModule/idDataProvider
	 * @return \Sh\DataSource
	 */
	static public function getModuleDataProviderByAlias( $idDataProvider ) {
		list($idModule, $idDataProvider) = explode('/', $idDataProvider);
		return self::getModuleDataProvider($idModule, $idDataSource);
	}
