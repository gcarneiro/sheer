...
?>
<section class="sh-box sh-box-azul sh-w-600 ">
	...
	<div class="sh-box-content">
		...
		<form class="sh-form sh-form-azul" action="action.php?ah=malaDiretaListaImportacao/adicionarVariosEmails" method="post" novalidate sh-form >
