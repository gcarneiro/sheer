...
class adicionarImagem extends \Sh\GenericAction {
	...
	public function doAction($data) {
		...
		$ultimaImagem = \Sh\ContentProviderManager::loadContent('imageRepository/ultimaImagemDoAlbum', $data);
		...
		//BUSCO O ALBUM
		$album = \Sh\ContentProviderManager::loadContentById('imageRepository/album', $data['idRepository']);
		if( !$album ) {
		...
		$filePicture = \Sh\ContentProviderManager::loadContentById('filePicture/filePicture', $responsePicture['data']['idPicture']);
...
class removerImagem extends \Sh\GenericAction {
	...
	public function doAction($data) {
		...
		//CAPTURO A IMAGEM
		$imagem = \Sh\ContentProviderManager::loadContentById('imageRepository/picture', $data['id']);
		if( !$imagem ) {
			throw new \Sh\SheerException(array(
				'code' => null,
		...
		$album = \Sh\ContentProviderManager::loadContentById('imageRepository/album', $imagem['idRepository']);
		if( !$album ) {
			throw new \Sh\SheerException(array(
				'code' => null,
...
class removerTodasImagem extends \Sh\GenericAction {
	...
	public function doAction($data) {
		...
		$album = \Sh\ContentProviderManager::loadContentById('imageRepository/album', $idRepository);
		if( !$album ) {
			throw new \Sh\SheerException(array(
				'code' => null,
