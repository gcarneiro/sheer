...
<head>
	...
	<title>{{page.title}}</title> {{page.baseUrl}}
			...
			<div id="shRouteHolder" class="col-xs-12 col-sm-10 col-md-9">
				...
				<section class="sh-box">
					<div class="sh-box-content">
						...
						<h1>Introdução ao Sheer</h1>
			
						<p>O Sheer é um framework server e client side, ou seja, um monte de coisas juntas que funcionam sem documentação alguma. Estamos tentando documenta-lo e padroniza-lo.</p>
			
						<p>Para entendermos o Sheer precisamos entender do que ele é composto. O Sheer é todo baseado em módulos e os elementos abaixo</p>
						
						<ul>
							<li><span class="code"><a href="#modulos">Módulos</a></span> Entidade para registro de um módulo de inteligencia</li>
							<li><span class="code"><a href="#">dataSource</a></span> Representa uma ligação com o banco de dados. Pertence a um módulo. </li>
							<li><span class="code"><a href="#">dataProvider</a></span> Registra um método para ler dados de um <span class="code">dataSource</span> e retorna-los em padrão bem definido. Pertence a um módulo. </li>
							<li><span class="code"><a href="#">renderable</a></span> Registra uma entidade que irá ser responsável por capturar <span class="code">dataProviders</span> e renderizar seus dados. Pertence a um módulo. </li>
							<li><span class="code"><a href="#">actionHandler</a></span> Registro de uma ação mapeada no sistema. Pertence a um módulo. </li>
							<li><span class="code"><a href="#">Jobs</a></span>Registra uma tarefa que o Sheer deverá executar de tempos em tempos. Pertence a um módulo. </li>
						</ul>
						...
						<ul>
							<li>
								...
								Para o <span class="code"><a href="#imageRepository">imageRepository</a></span> é possível configurar os mapas de imagens <span class="code"><a href="#pictureMap">pictureMap</a></span> para utilização.
							</li>
						...
						<p>É Responsável por capturar os dados de um <span class="code">dataSource</span> e devolver com informações sobre os mesmos.</p>
						<p>
							Configurável de diversas formas para facilitar a obtenção dos dados oferece recursos como relacionamento de dataSources, 
							filtros próprios ou externos (relacionamento), ordenação dos dados, limitantes e offsets.
						</p>
			
						<h3 id="renderables">Renderables</h3>
			
						<p>
							Faz a ponte entre a obtenção dos dados e a sua exibição. 
							Ele permite descrever quantos <span class="code">dataProvider</span> e relaciona-los a diversos arquivos php de estilo, 
							podendo escolher em sua execução qual utilizar.
						</p>
